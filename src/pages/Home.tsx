      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <section className="mb-8">
          <div className="max-w-4xl">
            <h1 className="text-3xl sm:text-4xl font-bold text-travel-800">{getWelcomeMessage()}</h1>
          ...
          <section className="mt-12 bg-gradient-to-r from-travel-600 to-coral-500 rounded-xl p-8 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Button variant="default" size="lg" className="bg-white text-travel-700 hover:bg-gray-100" asChild>
