  ...
  return (
    <Card className="mt-6 border-travel-100">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg text-travel-700">Performance Statistics</CardTitle>
      </CardHeader>
      <CardContent>
